...
trait StringOps extends Base with OverloadHack { self: ArraysBase =>
  ...
  def infix_+(s1: Rep[String], s2: Rep[Any])(implicit o: Overloaded2) = string_plus(s1,s2)
...
trait StringOpsExp extends StringOps with BaseExp { self: ArraysBase =>
...
trait ScalaGenString extends ScalaGenBase  { this: StringOpsExp with ArraysBase =>
